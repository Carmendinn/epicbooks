    ...
    return (
        ...
        >
            ...
            <div className="p-2 h-1/3 flex flex-col justify-between">
                ...
                <button className="mt-auto w-[100px] inline-flex items-center px-2 py-1 text-xs font-medium text-center text-white bg-pink-400 rounded-lg hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={() =>navigate('/details/'+book.asin)}>
                See more
