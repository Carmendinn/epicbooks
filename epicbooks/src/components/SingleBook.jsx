    ...
    <div 
        ...
        >
            ...
            <div className="p-2 h-1/3 flex flex-col justify-between">
                <a href="#">
                    <h5 className="mb-1 text-lg font-bold tracking-tight text-gray-900 dark:text-white">{book.title}</h5>
                </a>
                <p className="mb-1 text-sm font-normal text-gray-700 dark:text-gray-400">{book.description}</p>
                <a href="#" className="mt-auto w-[100px] inline-flex items-center px-2 py-1 text-xs font-medium text-center text-white bg-pink-400 rounded-lg hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Read more
